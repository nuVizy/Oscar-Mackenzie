      ...
      <div className="flex flex-col lg:flex-row items-center gap-12 md:gap-20">
        <div className="w-full lg:w-1/2 space-y-8 md:space-y-12">
          <div className="space-y-4 text-center lg:text-left">
             <span className="text-blue-500 font-mono text-xs font-bold">COVERAGE</span>
          ...
          <div className="p-6 md:p-8 border-l border-blue-500 bg-white/[0.02]">
        ...
        <div className="w-full lg:w-1/2 grid grid-cols-2 gap-3 md:gap-4">
          {areas.map(area => (
            <div key={area} className="p-6 md:p-8 border border-white/5 glass-panel group hover:bg-blue-600 transition-all duration-300">
              <div className="flex items-center space-x-3 md:space-x-4">
                 <div className="w-1.5 h-1.5 bg-blue-500 group-hover:bg-white"></div>
