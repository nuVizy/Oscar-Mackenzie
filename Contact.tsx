        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-20">
          <div className="space-y-8 md:space-y-12 text-center lg:text-left">
            ...
            <div className="space-y-4 md:space-y-8">
              <a href="tel:+447356080627" className="flex items-center justify-center lg:justify-start space-x-6 group">
                ...
                <div>
                   ...
                   <span className="text-xl md:text-3xl font-black group-hover:text-blue-500 transition-colors tracking-tighter uppercase">+44 7356 080627</span>
                </div>
              </a>

              <a href="mailto:contact@omackenzieservices.co.uk" className="flex items-center justify-center lg:justify-start space-x-6 group">
                <div className="w-16 h-16 md:w-20 md:h-20 border border-white/10 flex items-center justify-center group-hover:border-blue-500 transition-colors flex-shrink-0">
                ...
                <div className="min-w-0">
                   ...
                   <span className="text-sm md:text-2xl font-black group-hover:text-blue-500 transition-colors tracking-tighter lowercase block truncate">contact@omackenzieservices.co.uk</span>
                </div>
              </a>
            </div>
          </div>
