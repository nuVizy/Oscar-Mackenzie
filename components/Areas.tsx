    ...
    <section id="areas" className="py-20 md:py-32 px-6 md:px-12 max-w-[1600px] mx-auto">
      <div className="flex flex-col lg:flex-row items-center gap-12 md:gap-20">
        <div className="w-full lg:w-1/2 space-y-8 md:space-y-12">
          ...
          <div className="glass-card p-6 md:p-8 rounded-xl border-l-4 border-orange-500">
        ...
        <div className="w-full lg:w-1/2 grid grid-cols-2 gap-3 md:gap-4">
          {areas.map(area => (
            <div key={area} className="glass-card p-6 md:p-8 group hover:bg-orange-600 transition-all duration-300 rounded-xl">
