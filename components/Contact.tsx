        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-20">
          <div className="space-y-8 md:space-y-12 text-center lg:text-left">
            <div className="space-y-4">
              <span className="text-orange-500 font-mono text-[10px] md:text-xs font-bold">GET IN TOUCH</span>
            ...
            <div className="space-y-4 md:space-y-8">
              <a href="tel:07703620023" className="flex items-center justify-center lg:justify-start space-x-6 group">
                <div className="glass-card w-16 h-16 md:w-20 md:h-20 flex items-center justify-center flex-shrink-0 rounded-xl">
                ...
                <div>
                   ...
                   <span className="text-xl md:text-3xl font-black group-hover:text-orange-500 transition-colors tracking-tighter uppercase">07703 620023</span>
                </div>
              </a>
              ...
              <a href="mailto:enquiries@omackenzieservices.co.uk" className="flex items-center justify-center lg:justify-start space-x-6 group">
                ...
                <div className="min-w-0">
                   ...
                   <span className="text-sm md:text-2xl font-black group-hover:text-orange-500 transition-colors tracking-tighter lowercase block truncate">enquiries@omackenzieservices.co.uk</span>
                </div>
              </a>
            </div>
          </div>

          <div className="glass-panel p-6 md:p-16 space-y-6 md:space-y-8 rounded-2xl">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                <div className="space-y-2">
                  ...
                  <input type="text" placeholder="John Doe" className="glass-input w-full px-4 py-3 md:py-4 focus:outline-none text-sm placeholder:text-gray-600 rounded-lg" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-mono text-gray-600 uppercase tracking-widest">Phone Number</label>
                  <input type="tel" placeholder="07xxx xxxxxx" className="glass-input w-full px-4 py-3 md:py-4 focus:outline-none text-sm placeholder:text-gray-600 rounded-lg" />
                </div>
              </div>
              <div className="space-y-2">
                <label className="text-[10px] font-mono text-gray-600 uppercase tracking-widest">How can we help?</label>
                <textarea placeholder="Tell us about your project or repair..." className="glass-input w-full px-4 py-3 md:py-4 focus:outline-none text-sm resize-none h-24 md:h-32 placeholder:text-gray-600 rounded-lg"></textarea>
              </div>
              <button className="w-full py-5 md:py-6 bg-white text-black text-[11px] md:text-xs font-black uppercase tracking-[0.4em] hover:bg-orange-600 hover:text-white transition-all active:scale-95 shadow-xl rounded-lg hover:shadow-[0_0_30px_rgba(255,140,0,0.3)]">
                Get Your Free Quote
              </button>
            </form>
          </div>
