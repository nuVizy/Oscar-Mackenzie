        ...
        <div className="max-w-2xl mx-auto">
          <div className="space-y-12 text-center">
            ...
            <div className="space-y-6">
              <a href="tel:+447356080627" className="flex items-center justify-center lg:justify-start gap-6 group">
                ...
                <div className="text-left">
                   ...
                   <span className="text-2xl font-black group-hover:text-orange-500 transition-colors tracking-tight">+44 7356 080627</span>
                </div>
              </a>
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-3 px-8 py-5 bg-[#25D366] text-white text-sm font-black uppercase tracking-widest hover:bg-[#20BA5A] transition-all active:scale-95 shadow-xl"
            >
