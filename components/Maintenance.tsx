    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black flex items-center justify-center px-4">
      <div className="text-center max-w-2xl">
        <div className="mb-8">
          ...
          />
          <h1 className="text-9xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-orange-500 mb-4" style={{ fontFamily: 'Syncopate, sans-serif' }}>
            503
          </h1>
          <div className="h-1 w-32 bg-gradient-to-r from-yellow-500 to-orange-500 mx-auto mb-8"></div>
        </div>
        ...
        <div className="space-y-6">
          <div className="animate-pulse">
            <div className="h-2 bg-gradient-to-r from-orange-500 to-orange-300 rounded-full w-64 mx-auto"></div>
          </div>
